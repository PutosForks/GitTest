...
import com.example.mfe.service.PlayerExceptionClass;
import com.example.mfe.service.PlayerService;
...
public class PlayerController {
    ...
    public ModelAndView create(@Valid @ModelAttribute Player player, BindingResult bindingResult) {
